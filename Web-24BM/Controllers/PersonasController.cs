...
namespace Web_24BM.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,CURP,FechaNacimiento,rfc,puesto")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,CURP,FechaNacimiento,rfc,puesto")] Persona persona)
        {
            if (id != persona.Id)
            {
                return NotFound();
